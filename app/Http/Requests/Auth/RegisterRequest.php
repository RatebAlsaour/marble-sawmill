...
class RegisterRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'user_type' => ['required', Rule::in(UserTypeEnum::Client, UserTypeEnum::Supplier, UserTypeEnum::MANAGERIAL)],
            'role_id' => Rule::requiredIf(fn () => \request()->get('user_type') == UserTypeEnum::MANAGERIAL),
            'fcm_token' => Rule::requiredIf(fn () => \request()->get('user_type') == UserTypeEnum::Client),
            'provider_token' => 'sometimes',
            'provider' => 'sometimes',
        ];
    }
}
