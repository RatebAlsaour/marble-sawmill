...
@section('form-route'){{route('costs.update', $cost->id)}}@endsection
...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{!! route('costs.index') !!}">{{__('common.costs')}}</a></li>
...
<div class="row">
    <div class="tab-content border border-top-0 p-3 w-100" id="myTabContent">
        <div class="tab-pane fade show active" id="users-overview" role="tabpanel" aria-labelledby="costs-overview-tab">
            @include('pages.cost.form', ['cost' => $cost, 'source' => 'update'])
        </div>
    </div>
</div>
@endsection
