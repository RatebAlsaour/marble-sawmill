...
@section('formm-route'){{route('costs.create')}}@endsection
@section('formm-method') @method('post') @endsection
...
<ul class="nav nav-tabs" id="myTab" role="tablist">
    <li class="nav-item">
        <a class="nav-link active" id="currencies-overview-tab" data-toggle="tab" href="#users-overview" role="tab"
...
<div class="row">
    <div class="tab-content border border-top-0 p-3 w-100" id="myTabContent">
        <div class="tab-pane fade show active" id="users-overview" role="tabpanel" aria-labelledby="currencies-overview-tab">
