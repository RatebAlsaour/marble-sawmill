...
@include('layout.datatable')
    ...
    @include('pages.category.form_modal')
@stop
@push('custom-scripts')
    <script>
        $(function () {
            $('#category-table').DataTable({
                ...
                buttons: datatableButtons([{
                    ...
                    text: "<i class=\"fa fa-plus text-capitalize font-weight-bold\" data-toggle=\"modal\" data-target=\"#add-category-modal\"> create</i>",
                }], false, false, false),
        ...
        deleteAction('category-table', 'categories')
    </script>
@endpush
