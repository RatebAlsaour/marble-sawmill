            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <table id="client-invoices-table"
...
@include('pages.client_invoice.form_modal', ['clients' => $clients ,'categories'=>$categories])
@stop
@push('custom-scripts')
    <script>
        $(function () {
            $('#client-invoices-table').DataTable({
                ...
                buttons: datatableButtons([{
                    ...
                    text: "<i class=\"fa fa-plus text-capitalize font-weight-bold\" data-toggle=\"modal\" data-target=\"#add-client-invoice-modal\"> create</i>",
                }], false, false, false),
        ...
        deleteAction('client-invoices-table', 'client-invoices')
    </script>
@endpush
