...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'entity_id' => 'العنصر',
        'educational_party_id' => 'الجهة التعليمية',
        'details' => 'التفاصيل',
        'elapsed_time' => 'الوقت المنصرم',
        'wrong_answers_count' => 'عدد الإجابات الخاطئة',
        'correct_answers_count' => 'عدد الإجابات الصحيحة',
        'degree_due' => 'الدرجة المستحقة',
        'question_id' => 'معرف السؤال',
        'answer_id' => 'معرف الإجابة',
        'is_correct' => 'الإجابة المختارة',
        'daftra_id' => 'معرف الربط مع دفترة',
        'phone_number' => 'رقم الجوال',
        'checkout_id' => 'معرّف العملية',
        'value' => 'القيمة',
    ],
